...
import 'package:aplicacion/page/SplashScreen.dart'; // Asegúrate de importar SplashScreen
...
const firebaseConfig = FirebaseOptions(
  ...
  storageBucket:
      "gs://proyecto-de-grado-adc82.appspot.com", //ruta de acceso a storage.
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SplashScreen(), // Cambia el home a SplashScreen
    );
  }
}
